...
// You can find example on the https://github.com/get-ion/ion/tree/master/_examples/testing/httptest
func New(t *testing.T, app *ion.Application, setters ...OptionSetter) *httpexpect.Expect {
	conf := DefaultConfiguration()
	for _, setter := range setters {
		setter.Set(conf)
	}

	// disable logger by setting it to the  "Panic" level, ion never uses this
