...
This folder provides easy to understand code snippets on how to get started with [ion](https://github.com/get-ion/ion) micro web framework.
...
ion cache library lives on its own package: [https://github.com/get-ion/cache](https://github.com/get-ion/cache) **it contains examples**

### Sessions

ion session manager lives on its own package: [https://github.com/get-ion/sessions](https://github.com/get-ion/sessions) **it contains examples**

> You're free to use your own favourite sessions package if you'd like so.

### Websockets

ion websocket library lives on its own package: [https://github.com/get-ion/websocket](https://github.com/get-ion/websocket) **it contains examples**

> You're free to use your own favourite websockets package if you'd like so.

### Typescript Automation Tools

typescript automation tools have their own repository: [https://github.com/get-ion/typescript](https://github.com/get-ion/typescript) **it contains examples**

> I'd like to tell you that you can use your favourite but I don't think you will find such a thing anywhere else.

### Hey, You!

Developers should read the [godocs](https://godoc.org/github.com/get-ion/ion) for a better understanding.

Psst, I almost forgot; do not forget to [star or watch](https://github.com/get-ion/ion/stargazers) the project in order to stay updated with the latest tech trends, it never takes more than a second!
