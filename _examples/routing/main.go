...
"basic"
"dynamic-path"
and "reverse" examples if you want to release ion' real power.
*/

const maxBodySize = 1 << 20
const notFoundHTML = "<h1> custom http error page </h1>"

func registerErrors(app *ion.Application) {
...
func registerGamesRoutes(app *ion.Application) {
...
func registerSubdomains(app *ion.Application) {
